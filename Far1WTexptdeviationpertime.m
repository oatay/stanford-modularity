...
if size(perincrd,2) > 10
    save([backgroundfile,'wtexptdeviationpertime'],'perincrd','perincrm',...
        'perincrpertimed','perincrpertimem','sloped','slopem','arresttimed',...
        'arresttimem','chosencellposd','chosencellnod');
end