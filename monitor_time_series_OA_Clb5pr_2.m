function [cell_data]=monitor_time_series_OA_Clb5pr_2(flc,initial_tp,no_cell_of_interest,...
...
curr_plot_Whi5Cyt=[all_obj.cyt_Far1(no_cell_of_interest,:) zeros(1,5)];

only = size(all_obj.volume,1);
curr_plot_Whi5 = all_obj.tot_nucl_areaR.*all_obj.nuc_Far1 + all_obj.tot_cyt_areaR(1:only,:).*all_obj.cyt_Far1;
curr_plot_Whi5 =0.003.*[curr_plot_Whi5(no_cell_of_interest,:) zeros(1,5)];

curr_plot_Whi5N = all_obj.nuc_Far1-all_obj.cyt_Far1;
curr_plot_Whi5N = 20.*[curr_plot_Whi5N(no_cell_of_interest,:) zeros(1,5)];
%-----------------------
