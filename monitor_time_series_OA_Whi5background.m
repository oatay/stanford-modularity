function [cell_data]=monitor_time_series_OA_Whi5background(flc,initial_tp,no_cell_of_interest,...
...
curr_plot_Whi5C = curr_plot_Whi5C./5;
curr_plot_Far1N = curr_plot_Far1nuc;
...
while checkbutton~=2
    ...
    if (button==29) %forward in time
        ...
        if current_time>no_tp
            ...
            figure(1)
            subplot(2,2,1);plot(curr_plot_Far1T,'color',[0.0 0.5 0.0]);hold on; plot(curr_plot_Whi5C,'color',[0.0 0.2 1.0]);plot(curr_plot_Far1N,'color',[0.2 0.0 0.0]);
...
if button ==1 || button ==3
    for j=1:4
        plot(curr_plot_Far1T,'color',[0.0 0.5 0.0]);hold on; plot(curr_plot_Whi5C,'color',[0.0 0.2 1.0]);
        ...
        if j==1
            xlabel('mark background correction (begin)-before arrest')
            [x1,y1,btmp]=ginput(1);
            plot([x1 x1],[0 max_v],'color',[1 0 0],'linewidth',2)
            cell_data(1,5)=min([numbM x1]);
        elseif j==2
            xlabel('mark background correction (end)-before arrest')
            [x1,y1,btmp]=ginput(1);
            plot([x1 x1],[0 max_v],'color',[1 0 0],'linewidth',2)
            cell_data(1,6)=min([numbM x1]);
        elseif j==3
            xlabel('mark background correction (begin)-arrest')
            [x1,y1,btmp]=ginput(1);
            plot([x1 x1],[0 max_v],'color',[1 1 0],'linewidth',2)
            cell_data(1,7)=min([numbM x1]);
        elseif j==4
            xlabel('mark background correction (end)-arrest')
            [x1,y1,btmp]=ginput(1);
            plot([x1 x1],[0 max_v],'color',[1 1 0],'linewidth',2)
